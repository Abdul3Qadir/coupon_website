...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $colors = ['rose', 'blue', 'emerald', 'amber', 'violet', 'pink', 'orange', 'teal', 'indigo', 'cyan'];
        $trendingNames = ['Fashion', 'Beauty', 'Travel'];
        ...
        foreach ($categories as $category) {
            Category::updateOrCreate(
                ...
                [
                    ...
                    'is_trending' => in_array($category['name'], $trendingNames, true),
                ]
            );
        }
    }
