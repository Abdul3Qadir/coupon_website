<x-layouts.admin title="Add Blog Category">
    ...
    <div class="max-w-2xl rounded-2xl border border-gray-200 bg-white p-6">
        <h1 class="font-Manrope text-lg font-extrabold text-gray-900">Add Blog Category</h1>

        <form method="POST" action="{{ route('admin.blog-categories.store') }}" class="mt-5">
            @csrf
            @php $blogCategory = null; @endphp
