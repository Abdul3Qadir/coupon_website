...
<div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <label class="cursor-pointer">
            <input type="radio" name="type" value="coupon" class="peer sr-only" @checked(old('type', $offer->type->value ?? 'coupon') === 'coupon')>
            <div class="rounded-xl border-2 border-gray-200 peer-checked:border-red-500 peer-checked:bg-red-50 px-4 py-4 text-center transition hover:border-gray-300">
                ...
                <p class="mt-0.5 font-Inter text-xs text-gray-500">Customer enters a code</p>
            </div>
        </label>
        <label class="cursor-pointer">
            ...
            <div class="rounded-xl border-2 border-gray-200 peer-checked:border-red-500 peer-checked:bg-red-50 px-4 py-4 text-center transition hover:border-gray-300">
                ...
                <p class="mt-0.5 font-Inter text-xs text-gray-500">No code, applies on click</p>
            </div>
        </label>
    </div>
</div>
...
<div class="mt-6">
    ...
    <select name="category_id" required class="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 font-Inter text-sm text-gray-900 outline-none focus:border-red-300 focus:ring-2 focus:ring-red-100 transition">
...
<div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <select name="discount_type" required class="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 font-Inter text-sm text-gray-900 outline-none focus:border-red-300 focus:ring-2 focus:ring-red-100 transition">
...
<div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <input type="date" name="starts_at" value="{{ old('starts_at', optional($offer->starts_at ?? null)->format('Y-m-d')) }}" class="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 font-Inter text-sm text-gray-900 outline-none focus:border-red-300 focus:ring-2 focus:ring-red-100 transition">
    </div>
    <div>
        ...
        <input type="date" name="expires_at" value="{{ old('expires_at', optional($offer->expires_at ?? null)->format('Y-m-d')) }}" class="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 font-Inter text-sm text-gray-900 outline-none focus:border-red-300 focus:ring-2 focus:ring-red-100 transition">
