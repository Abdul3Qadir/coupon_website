        ...
        <div class="mt-10 sm:mt-12 grid min-[380px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
            <a href="/stores/brand" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-orange-200">
                <span class="absolute -top-2 left-4 inline-flex items-center gap-1 rounded-full bg-orange-500 px-2.5 py-0.5 font-Inter text-[10px] font-bold uppercase tracking-wide text-white shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" color="/stores/brandffffff" fill="none" stroke="/stores/brandffffff" stroke-width="2" stroke-linejoin="round">
