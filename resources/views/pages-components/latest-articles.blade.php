<section class="py-14 sm:py-20 bg-[#f8f9fb]">
    <div class="max-w-7xl mx-auto px-3 xs:px-4 sm:px-8 lg:px-10">
        <div class="relative text-center">
            ...
            <a href="/blog" class="hidden sm:inline-flex absolute right-0 top-1/2 -translate-y-1/2 items-center gap-1 font-Inter text-sm font-semibold text-red-600 hover:text-red-700">
                View All
        ...
        <a href="/blog" class="mt-8 flex sm:hidden items-center justify-center gap-1 font-Inter text-sm font-semibold text-red-600">
            View All Articles
            <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
        </a>
    </div>
