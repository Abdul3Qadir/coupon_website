  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a href="/deals" class="group bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
        ...
        <div class="grow">
          <h3 class="font-Manrope text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors">Zara Summer Clearance</h3>
      ...
      <a href="/deals" class="group bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
        ...
        <div class="grow">
          <h3 class="font-Manrope text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors">Ikea Home Refresh Sale</h3>
      ...
      <a href="/deals" class="group bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
        ...
        <div class="grow">
          <h3 class="font-Manrope text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors">Hostinger Anniversary Sale</h3>
