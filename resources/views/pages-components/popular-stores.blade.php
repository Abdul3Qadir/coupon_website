<section class="py-12">
    <div class="max-w-7xl mx-auto px-3 xs:px-4 sm:px-8 lg:px-10">
        ...
        <div class="mt-10 sm:mt-12 grid min-[380px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">38 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">35 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">34 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <p class="mt-3 font-Manrope text-sm font-bold text-gray-900 text-center">Zara</p>
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">31 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <p class="mt-3 font-Manrope text-sm font-bold text-gray-900 text-center">Hostinger</p>
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">29 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <p class="mt-3 font-Manrope text-sm font-bold text-gray-900 text-center">Ikea</p>
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">27 coupons</span>
            </a>
            ...
            <a href="#" class="group relative flex flex-col items-center rounded-2xl bg-white p-5 border border-gray-200 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-amber-200">
                ...
                <p class="mt-3 font-Manrope text-sm font-bold text-gray-900 text-center">Zara</p>
                <span class="mt-1.5 rounded-full px-2.5 py-0.5 font-Inter text-xs font-semibold text-amber-600">25 coupons</span>
            </a>
        </div>
