...
<body class="font-Inter bg-[#f8f9fb]">
    ...
    <aside id="dashboardSidebar" class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col -translate-x-full border-r border-gray-200 bg-white transition-transform duration-200 lg:translate-x-0">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4">
            ...
            <x-admin.sidebar-link href="{{ route('admin.offers.index') }}"  :active="request()->routeIs('admin.offers.*')" :badge="$pendingOffersCount ?? null">
            ...
            @if ($isSuperAdmin)
                ...
                <x-admin.sidebar-link :href="route('admin.analytics.index')" :active="request()->routeIs('admin.analytics.*')">
