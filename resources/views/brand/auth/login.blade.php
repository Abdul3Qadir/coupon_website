...
<body class="font-Inter">
    <x-auth-card title="Brand Login" subtitle="Manage your coupons, deals, and analytics">
        <x-slot:footer>
            Don't have an account?
            <a href="{{ route('brand.register') }}" class="font-semibold text-red-600 hover:text-red-700">Register your brand</a>
        </x-slot:footer>
        ...
        <form method="POST" action="{{ route('brand.login') }}" class="space-y-4">
            @csrf
