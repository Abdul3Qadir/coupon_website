<x-layouts.brand title="Add Coupon or Deal">
    <div class="max-w-2xl mx-auto px-4 sm:px-0">
        <div class="mb-8 text-center sm:text-left">
            ...
            <p class="mt-1 font-Inter text-sm text-gray-500">Create a coupon or deal for your customers</p>
        </div>

        <div class="rounded-2xl bg-white border border-gray-200 shadow-sm p-5 sm:p-8">
            <form method="POST" action="{{ route('brand.offers.store') }}">
                @csrf
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <button type="submit" class="w-full inline-flex items-center justify-center rounded-xl bg-red-600 px-6 py-3 font-Inter text-sm font-semibold text-white cursor-pointer hover:bg-red-700 transition">
                        Create Offer
                    </button>
