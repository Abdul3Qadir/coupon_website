    ...
    <section class="relative overflow-hidden bg-white py-14">
            <div class="relative max-w-7xl mx-auto px-3 xs:px-4 sm:px-8 lg:px-10 text-center">
                ...
                <div class="mx-auto mt-7 flex max-w-xl items-center overflow-hidden rounded-full border border-gray-200 bg-white pl-6 pr-2 py-2 shadow-lg shadow-gray-100 focus-within:border-red-300 focus-within:ring-2 focus-within:ring-red-100 transition">
                    ...
                    <button type="button" class="shrink-0 w-10 h-10 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center transition">
...
<section class="py-8 sm:py-10 border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-3 xs:px-4 sm:px-8 lg:px-10">
        <div class="flex items-center gap-2.5 overflow-x-auto no-scrollbar">
            <a href="#" class="shrink-0 rounded-full bg-gray-900 px-4 py-2 font-Manrope text-sm font-semibold text-white">All Categories</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Fashion</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Beauty</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Travel</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Web Hosting</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Home &amp; Living</a>
            <a href="#" class="shrink-0 rounded-full bg-gray-50 hover:bg-gray-900 hover:text-white px-4 py-2 font-Manrope text-sm font-semibold text-gray-800 transition">Electronics</a>
        </div>
    </div>
</section>
...
<section class="py-10 sm:py-14">
    <div class="max-w-7xl mx-auto px-3 xs:px-4 sm:px-8 lg:px-10">
        ...
        <div class="mt-10 sm:mt-12 flex flex-col items-center gap-3">
            <p class="font-Inter text-sm text-gray-500">Showing 24 of 1,240 stores</p>
            <button type="button" class="inline-flex items-center gap-2 rounded-full bg-white border border-gray-200 hover:border-red-200 hover:bg-red-50 px-6 py-3 font-Manrope text-sm font-semibold text-gray-900 hover:text-red-600 shadow-sm transition">
                Load More Stores
